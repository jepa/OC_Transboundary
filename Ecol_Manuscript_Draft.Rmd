...
```{r Figure_4, eval = T, echo =F, fig.cap="Percentage change of stock-share ratio for IPHC under two RCPs for Mid century (2046-2055)"}
...
Fig4 <- readPNG("./Figures/Ecol/Fig5.png")
grid.raster(Fig5)
...
Fig4 <- readPNG("./Figures/Ecol/Fig6.png")
grid.raster(Fig5)
