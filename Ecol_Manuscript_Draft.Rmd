...
```{r Figure_1, eval = T, echo =F, fig.cap="Map of North America with the regulatory areas of the IPHC and the NAFO sub-region related to the Gulf of Main agreement"}

img <- readPNG(here("Figures/Ecol/Fig1.png"))
grid.raster(img)

```


<!-- ![Fig 1. Map of North America with the regulatory areas of the IPHC and the NAFO sub-region related to the Gulf of Main agreement](./Figures/Ecol//Fig1.png) -->
...
#Data provided by Vicki Lam
EEZIDs_List <- read_excel(here("Data/Spatial/Updated_EEZList_17June2016.xlsx"))
EEZ_CellID <- read_excel(here("Data/Spatial/EEZ_CellID.xlsx"))
colnames(EEZ_CellID) <- c("EEZID","INDEX")

# DBEM Coordinate system
Coor <- fread(here("Data/Spatial/Lon_Lat_DBEM.txt"),header = FALSE)
colnames(Coor) <- c("INDEX","Longitude","Latitude")

# From (/Users/jpalacios/Documents/UBC/Oceans_Project/Distribution/By Cell/By_Cell_Analysis.Rmd)
Raw_DBEM_Results <- data.table::fread(here("Data/Distribution/Raw_Data.csv")) %>% 
...
```{r Figure_2, eval = T, echo =F, fig.cap="Percentage change of MCP of transboundary fisheries of North America for mid century (2046-2055) referent to 2005-2014 under a A) low emission scenario and; B) high emission scenario."}

img <- readPNG(here("Figures/Ecol/Fig2.png"))
grid.raster(img)

```


<!-- ![Fig 2. Percentage change of MCP of transboundary fisheries of North America for mid century (2046-2055) referent to 2005-2014 under a A) low emission scenario and; B) high emission scenario.](./Figures/Ecol/Fig2.png) -->
...
```{r Figure_3, eval = T, echo =F, fig.cap="Percentage Change of MCP for Species managed by the IPHC. A, RCP 2.6 represents a low emission scenario (high mitigation). B, RCP 8.5 represents a high emission scenario (status quo)"}

img <- readPNG(here("Figures/Ecol/Fig3.png"))
grid.raster(img)
...
<!-- ![Fig 3. Percentage change of MCP for species managed by the IPHC for mid century (2046-2055) referent to 2005-2014 under a A) low emission scenario and B) high emission scenario.](./Figures/Ecol/Fig3.png) -->
...
```{r Figure_4, eval = T, echo =F, fig.cap="Percentage change of stock-share ratio for IPHC under A) low emission scenario and B) high emission scenario for mid century (2046-2055) referent to 2005-2014."}

Fig4 <- readPNG(here("Figures/Ecol/Fig4.png"))
grid.raster(Fig4)
...
<!-- ![Fig 4. Percentage change of stock-share ratio for IPHC under A) low emission scenario and B) high emission scenario for mid century (2046-2055) referent to 2005-2014.](./Figures/Ecol/Fig4.png) -->
...
```{r Figure_5, eval = T, echo =F, fig.cap="Percentage change of MCP in the Gulf of Main under, A) low emission scenario; and B) high emission for mid century (2041-2060) referent to present (2005-2014)"}

Fig5 <- readPNG(here("Figures/Ecol/Fig5.png"))
grid.raster(Fig5)

```


<!-- ![Fig 5. Percentage change of MCP in the Gulf of Main under, A) low emission scenario; and B) high emission for mid century (2041-2060) referent to present (2005-2014)](./Figures/Ecol/Fig5.png) -->
...
```{r Figure_6, eval = T, echo =F, fig.cap="Changes in MCP stock-share ratio for Gulf of Main under (A) low emission scenario; and (B) high emission for mid century (2041-2060) referent to 2005-2014"}

Fig6 <- readPNG(here("Figures/Ecol/Fig6.png"))
grid.raster(Fig6)

```


<!-- ![Fig 6. Changes in MCP stock-share ratio for Gulf of Main under (A) low emission scenario; and (B) high emission for mid century (2041-2060) referent to 2005-2014](./Figures/Ecol/Fig6.png) -->
