...
```{r Figure5-goma, eval = T, echo = F, fig.height = 4, fig.width = 6, fig.cap = "Percentage change of MCP in the Gulf of Maine under, A) high emission scenario; and B) low emission for mid-century (2041-2060) relative to present (2005-2014). Points represent regions where models do not agree in direction of change."}
...
```{r Figure-S1, eval = T, echo = F, fig.cap = "Variation of climate change scenarios"}
...
```{r Figure_S2, eval = T, echo = F, fig.cap = "Variation of climate change scenarios in IPHC regions 4E and 4D"}
...
```{r Figure_S3, eval = T, echo = F, fig.cap = "Outliers GoMA"}
