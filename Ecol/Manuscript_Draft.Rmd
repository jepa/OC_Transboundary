...
```{r FigureS11, eval = T, echo = F, fig.cap = "Percentage change of MCP for species managed by the IPHC for end-century (2081–2100) referent to 2005–2014 under a A) high emission scenario and B) low emission scenario. Labels marked with * represent regions where models do not agree in direction of change."}
